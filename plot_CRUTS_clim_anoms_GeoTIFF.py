...
if __name__ == "__main__":
    ...
    extra_metadata={"CREATOR":"Centre for Environmental Data Analysis (CEDA), STFC",
                    ...
                    "REFERENCE":"IPCC DDC climatological anomalies, CRU TS3.24.01"}
    if v == "tmp":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Near surface air temperature"
        extra_metadata["TITLE"] = "Near surface air temperature (anomaly) [celsius];"
    elif v == "tmx":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Near surface air temperature maximum"
        extra_metadata["TITLE"] = "Near surface air temperature maximum (anomaly) [celsius];"
    elif v == "tmn":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Near surface air temperature minimum"
        extra_metadata["TITLE"] = "Near surface air temperature minimum (anomaly) [celsius];"
    elif v == "cld":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Cloud cover"
        extra_metadata["TITLE"] = "Cloud cover (anomaly) [percentage];"
    elif v == "pet":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Potential Evapotranspiration"
        extra_metadata["TITLE"] = "Potential evapotranspiration (anomaly) [mm/day];"
    elif v == "dtr":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Near surface air temperature: diurnal range"
        extra_metadata["TITLE"] = "Near surface air temperature: diurnal range (anomaly) [celsius];"
    elif v == "frs":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Ground frost frequency"
        extra_metadata["TITLE"] = "Ground frost frequency (anomaly) [days];"
    elif v == "pre":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Precipitation"
        extra_metadata["TITLE"] = "Precipitation (anomaly) [kg m-2];"
    elif v == "vap":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Water vapor pressure"
        extra_metadata["TITLE"] = "Water vapor pressure (anomaly) [hPa];"
    elif v == "wet":
        extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] = "Wet day frequency"
        extra_metadata["TITLE"] = "Wet day frequency (anomaly) [days];"

    extra_metadata["TIFFTAG_IMAGEDESCRIPTION"] += " (anomalies, with respect to 1986 to 2005 reference)"
    extra_metadata["TITLE"] += " CRU TS3.24.01"

    in_dir = "/group_workspaces/jasmin/cedaproc/nrmassey/CRU_TS3.24.01/derived/clim-anom-ref5/"+v+"/netcdf/"
    out_dir = "/group_workspaces/jasmin/cedaproc/nrmassey/CRU_TS3.24.01/derived/clim-anom-ref5/"+v+"/geotiff/"
